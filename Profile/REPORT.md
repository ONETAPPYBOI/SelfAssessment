...
[![Skills](https://img.shields.io/badge/Self_Assessment-113&nbsp;/&nbsp;114&nbsp;/&nbsp;736-009933?style=flat-square)](https://github.com/ONETAPPYBOI/SelfAssessment/blob/main/Profile/REPORT.md)
...
```
<a href="https://github.com/ONETAPPYBOI/SelfAssessment/blob/main/Profile/REPORT.md"><img alt="Skills" src="https://img.shields.io/badge/Self_Assessment-113&nbsp;/&nbsp;114&nbsp;/&nbsp;736-009933?style=flat-square"></a>
```
...
| &nbsp;&nbsp;&nbsp;&nbsp; Statements u | `19` | `19` |
| &nbsp;&nbsp;&nbsp;&nbsp; Functions u | `10` | `10` |
| &nbsp;&nbsp;&nbsp;&nbsp; Data structures u | `8` | `8` |
| &nbsp;&nbsp;&nbsp;&nbsp; Standard classes and namespaces u | `14` | `14` |
| &nbsp;&nbsp;&nbsp;&nbsp; Infrastructure u | `6` | `6` |
...
Total: you have `71` of `72` skills, `1` to be upgraded, and `35` above needed

| To start Node.js | actual | ⟶  | required |
| --- | --- | --- | --- |
| `null` | 🤷 unknown | ⟶  | 🖐️ used |

Total: you have `97` of `98` skills, `1` to be upgraded, and `28` above needed
